 ...
 * However {@link com.fyfeng.android.tools.lang.CharSet} is not currently guaranteed thread-safe under all circumstances.</p>
 *
 * <p>The top level package contains various Utils classes, whilst there are various subpackages including {@link com.fyfeng.android.tools.lang.math}, {@link com.fyfeng.android.tools.lang.concurrent} and {@link com.fyfeng.android.tools.lang.builder}.
 ...
 * The first is {@link com.fyfeng.android.tools.lang.StringUtils}, oodles and oodles of functions which tweak, transform, squeeze and cuddle {@link java.lang.String java.lang.Strings}.
 * In addition to StringUtils, there are a series of other String manipulating classes; {@link com.fyfeng.android.tools.lang.RandomStringUtils} and {@link com.fyfeng.android.tools.lang.StringEscapeUtils StringEscapeUtils}.
 ...
 * StringUtils' {@link com.fyfeng.android.tools.lang.StringUtils#capitalize(String)}, {@link com.fyfeng.android.tools.lang.StringUtils#substringBetween(String, String)}/{@link com.fyfeng.android.tools.lang.StringUtils#substringBefore(String, String) Before}/{@link com.fyfeng.android.tools.lang.StringUtils#substringAfter(String, String) After}, {@link com.fyfeng.android.tools.lang.StringUtils#split(String)} and {@link com.fyfeng.android.tools.lang.StringUtils#join(Object[])} are good methods to begin with.</p>
 *
 ...
 * {@link com.fyfeng.android.tools.lang.CharUtils} exists for this purpose, while {@link com.fyfeng.android.tools.lang.CharSetUtils} exists for set-manipulation of Strings.
 ...
 *
 * <p>{@link com.fyfeng.android.tools.lang.CharRange} and {@link com.fyfeng.android.tools.lang.CharSet} are both used internally by CharSetUtils, and will probably rarely be used.</p>
 *
 ...
 *
 * <p>The {@link com.fyfeng.android.tools.lang.CharEncoding} class is also used to interact with the Java environment and may be used to see which character encodings are supported in a particular environment. </p>
 *
 ...
 *
 * <p>Would you believe it, {@link com.fyfeng.android.tools.lang.ObjectUtils} contains handy functions for Objects, mainly null-safe implementations of the methods on {@link java.lang.Object}.</p>
 *
 * <p>{@link com.fyfeng.android.tools.lang.ClassUtils} is largely a set of helper methods for reflection.
 ...
 *
 * <p>Next up, {@link com.fyfeng.android.tools.lang.ArrayUtils}.
 ...
 * </ul>
 *
 * <p>Lastly, {@link com.fyfeng.android.tools.lang.ArrayUtils#toMap(Object[])} is worthy of special note.
 ...
 * </pre>
 *
 * <p>Our final util class is {@link com.fyfeng.android.tools.lang.BooleanUtils}.
 * It contains various Boolean acting methods, probably of most interest is the {@link com.fyfeng.android.tools.lang.BooleanUtils#toBoolean(String)} method which turns various positive/negative Strings into a Boolean object, and not just true/false as with Boolean.valueOf.</p>
 *
 ...
 * <p>The {@link com.fyfeng.android.tools.lang.BitField} class provides a wrapper class around the classic bitmask integer, whilst the {@link com.fyfeng.android.tools.lang.Validate} class may be used for assertions (remember, we support Java 1.2). </p>
 *
 * @since 1.0
 */
